...
#### - A workbench named **`manage-resources-wb`** is already running under the **`manage-resources project`**
...
## **1. Add Data Connection to the Workbench**
  ...
  3. Click **`manage-resources-wb`**
  4. Click on **`DataConnection`**
  5. Create a new **`DataConnection`** if not there. 
