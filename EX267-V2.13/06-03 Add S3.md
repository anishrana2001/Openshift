...
|-------|--------|--------|
| <span style="color:#0066ff;">Blue</span> | Information | <span style="color:#0066ff;">This is an info note</span> |
| <span style="color:#28a745;">Green</span> | Success | <span style="color:#28a745;">✅ Success</span> |
| <span style="color:#dc3545;">Red</span> | Error/Critical | <span style="color:#dc3545;">❌ Error</span> |
| <span style="color:#fd7e14;">Orange</span> | Warning | <span style="color:#fd7e14;">⚠️ Warning</span> |
| <span style="color:#6f42c1;">Purple</span> | Important | <span style="color:#6f42c1;">**Must Do**</span> |
| <span style="color:#17a2b8;">Cyan</span> | Commands | <span style="color:#17a2b8;">`git checkout RHOAI2.13`</span> |



A <span style="color: #0066ff;">workbench</span> is already running `manage-resources-wb` under `manage-resources` project. 
