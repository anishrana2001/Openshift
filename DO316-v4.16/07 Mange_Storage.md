...
oc apply -f https://raw.githubusercontent.com/anishrana2001/Openshift/refs/heads/main/DO316-v4.16/replicated-template.yaml
oc apply -f https://raw.githubusercontent.com/anishrana2001/Openshift/refs/heads/main/DO316-v4.16/web1.template.yaml
```

# Manage Storage for VirtualMachines
- **Create 2 VirtualMachines** in project `vm-image` in the following way:
