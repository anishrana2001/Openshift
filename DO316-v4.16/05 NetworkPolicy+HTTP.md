...
sudo su -
```
- One can download the yum.repo file from the given link  `https://raw.githubusercontent.com/anishrana2001/Openshift/refs/heads/main/DO316-v4.16/yum.repo-file.repo`
```
