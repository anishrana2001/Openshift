...
oc get routes
```
## You can also check from Web GUI.
## Open a web browser and go to `https://console-openshift-console.apps.ocp4.example.com`. Click `htpasswd_provider` & then log in as the `developer` user with the `developer` password.
