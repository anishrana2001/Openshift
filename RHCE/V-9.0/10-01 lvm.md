...
```
### If these modules are not available then you can install the collection.

#### Install community.general (if you’re using ansible-core)
```
ansible-galaxy collection install community.general -p /home/student/ansible/my-collections
```
